...
def nncf_fx_2_ov_quantization(pt_model, example_input, output_dir, result, val_loader, shape_input):
    with disable_patching():
        ...
        params = AdvancedQuantizationParameters(disable_bias_correction=True)
        ...
        graph_path = f"b_nncf_{pt_model.__class__.__name__}_int8.svg"
        g.get_dot_graph().write_svg(graph_path)
        ...
        print(f"quantized model saves as {quant_file_path}")
