...
class GraphConverter:
    ...
    def get_edge_params(
        ...
        if source_node.op in ("get_attr",):
            ...
            if (
                source_nncf_node.metatype in [om.PTBatchNormMetatype, om.PTGroupNormMetatype, om.PTLayerNormMetatype]
                or source_nncf_node.metatype is om.PTScaledDotProductAttentionMetatype
                and len(source_node.meta["val"]) > 1
            ):
